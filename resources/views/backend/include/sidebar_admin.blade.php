<div class="leftpanel">
    ...
    <ul class="custom-menu">
        ...
        <li><a href="{{url('admin/reports')}}"> <i class="fa fa-folder-open"></i> প্রতিবেদন দেখুন</a></li>
                <li><a href="{{url('admin/uddokta-list')}}"> <i class="fa fa-users"></i> ইউজার তালিকা</a></li>

        <li><a href="{{url('admin/all-envelope-report')}}"> <i class="fa fa-envelope"></i> স্লীপ তৈরী করুন</a></li>
    </ul>
