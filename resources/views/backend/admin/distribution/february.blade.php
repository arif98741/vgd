...
@section('content')
    <div class="mainpanel">
        ...
        <div class="contentpanel">
            <h2 class="control-label text-center text-danger">ফেব্রুয়ারি মাসের ভিজিডি উপকারভোগী</h2>
...
{{--                        @if(!empty($row->id==$febDis[0]['beneficiary_id'] && $febDis[0]['status']==1)>0)--}}
...
{{--                        @else--}}
{{--                            <td>--}}
{{--                                <a href="{{url('admin/confirm/febDis/'.$row->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-hand-o-up"></i> প্রদান করুন</a>--}}
{{--                            </td>--}}
