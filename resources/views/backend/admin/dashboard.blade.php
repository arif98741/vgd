                    ...
                    <div class="panel panel-info-alt noborder">
                        <div class="panel-heading noborder">
                            ...
                            <div class="media-body">
                                ...
                                <h2 style="font-family:SutonnyMJ;" class="mt5">270 বস্তা</h2>
                            </div><!-- media-body -->
                            <hr>
                            <div class="clearfix mt20">
                                <div class="pull-left">
                                    <h5 class="md-title nomargin">চাউল গ্রহন করেছে</h5>
                                    <h4 style="font-family:SutonnyMJ;" class="nomargin">250 বস্তা</h4>
                                </div>
                                <div class="pull-right">
                                    <h5 class="md-title nomargin">চাউল বকেয়া আছে</h5>
                                    <h4 style="font-family:SutonnyMJ;" class="nomargin">20 বস্তা</h4>
                                </div>
                            </div>
