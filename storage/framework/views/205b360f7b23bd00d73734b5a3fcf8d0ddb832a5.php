                    ...
                    <tr>
                        <td width="41%" valign="top">
                            <div style="font-size:19px; text-align: center" class="title-1 ">
                                ...
                                <?php echo e($union); ?> ইউনিয়ন পরিষদ <br>
                            </div>
                            <div style="font-size:19px; text-align: center" class="title-1 ">
                                বিতরণকৃত মাস্টাররোল
                            </div>
                            <div style="font-size:17px; text-align: center" class="title-1 ">
                                ...
                                টি,
                                বাকী আছেঃ
                                <span style="font-family:SutonnyMJ;"><?php echo e($total_card - $reports->count()); ?></span> টি
                            </div>
                ...
                <table width="100%" class="table" border="0">
                    ...
                    <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="text-align: center">
                            <td align="left" style="text-align: center"><?php echo e(++$key); ?></td>
...
<?php /**PATH /home/melandah/vgf.melandahbhata.gov.bd/resources/views/backend/user/reports/all-beneficiaries-report.blade.php ENDPATH**/ ?>