<?php $__env->startSection('title', 'মেলান্দহ উপজেলার ভিজিএফ উপকারভোগীর ডাটাবেইজ'); ?>
        ...
        <div class="row">
            <div class="col-md-9 mt-1">
                <div class="pm">
                    <a href="https://www.youtube.com/watch?v=v1R-CB3e-pw" target="_blank" title="শেখ হাসিনা">
                        <img src="<?php echo e(asset('images/National-Portal-Card-PM.jpeg')); ?>" alt="National-Portal-Card-PM">
                    </a>
                </div>
            ...
            <div class="col-md-3 text-center">
                <div class="porikolpona-head mb-2 mt-5 animated fadeInDown" data-wow-duration="2s" data-wow-delay="5s">
                    <h5>উপদেষ্টা</h5>
                    <img src="<?php echo e(asset('/images/2140.jpg')); ?>" alt="">
                </div>
                ...
                <div class="porikolpona-head mb-2 mt-5 animated fadeInDown" data-wow-duration="2s" data-wow-delay="5s">
                    <h5>পরিকল্পনায়</h5>
                    <img src="<?php echo e(asset('/images/chairman.jpg')); ?>" alt="">
                </div>
                <div class="single-team-item animated fadeInDown" data-wow-duration="2s" data-wow-delay="5s">
                ...
                <div class="porikolpona-head mb-2 mt-5 animated fadeInUp" data-wow-duration="2s" data-wow-delay="5s">
                    <h5>বাস্তবায়নে</h5>
                    <img src="<?php echo e(asset('/images/uno.jpg')); ?>" alt="">
                </div>
...
<?php echo $__env->make('public.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/melandah/vgf.melandahbhata.gov.bd/resources/views/public/home.blade.php ENDPATH**/ ?>