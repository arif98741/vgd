<?php $__env->startSection('title','ভিজিএফ উপকারভোগী টাকা প্রদান'); ?>
<?php $__env->startSection('content'); ?>
    <div class="mainpanel">
        ...
        <div class="contentpanel">
            ...
            <h4 class="text-center">বিতরণকৃত টাকাঃ <span id="distribution"
                                                         style="font-family:SutonnyMJ;"> <?php echo e($distribution['distribution']); ?></span>
                টাকা, বিতরণ
                হয়নিঃ
                <spa id="due_distribution" style="font-family:SutonnyMJ;"><?php echo e($distribution['due_distribution']); ?></span>
                    টাকা, মোট
                    বরাদ্দঃ <span id="stock" style="font-family:SutonnyMJ;"><?php echo e($distribution['stock']); ?></span>
                    টাকা
            </h4>

            <h4 class="text-center">বিতরণকৃত কার্ডঃ <span
                    style="font-family:SutonnyMJ; font-size: 18px;"><?php echo e($card['distribution'][1]->total); ?></span> টি,
                বিতরণ হয়নিঃ
                <span style="font-family:SutonnyMJ; font-size: 18px;"><?php echo e($card['distribution'][0]->total); ?></span> টি,
                মোট
                কার্ডঃ <span
                    style="font-family:SutonnyMJ; font-size: 18px;"><?php echo e($card['distribution'][0]->total  + $card['distribution'][1]->total); ?></span>
                টি
            </h4>
            <h4 class="text-center">সর্বশেষ ভাতা গ্রহণকারীঃ <span
                    id="last_distributed_name"><?php echo e($last_distributed->beneficiary->name); ?></span>, পিতা/স্বামীঃ <span
                    id="last_distributed_fh_name"><?php echo e($last_distributed->beneficiary->fh_name); ?></span> , কার্ড নম্বরঃ
                <span
                    id="last_distributed_card_no"
                    style="font-family:SutonnyMJ; font-size: 18px;"><?php echo e($last_distributed->beneficiary->card_no); ?></span>,
                এনআইডি নম্বরঃ <span id="last_distributed_nid"
                                    style="font-family:SutonnyMJ; font-size: 18px;"><?php echo e($last_distributed->beneficiary->nid); ?></span>,
                ওয়ার্ডঃ <span id="last_distributed_ward"
                              style="font-family:SutonnyMJ; font-size: 18px;"><?php echo e($last_distributed->beneficiary->ward); ?></span>
            </h4>
    ...
    <style>
        #loader {
            ...
            width: 100%;
            height: 100%;
            background: url(<?php echo e(asset('images/loader.gif')); ?>) 50% 50% no-repeat #cccccc;
        }
    </style>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var table = $('#basicTable').DataTable({
                ...
                serverSide: true,
                ajax: "<?php echo e(url('user/distribution')); ?>",
                columns: [
    ...
    <script>
        ...
        $('#search_table').change(function () {
            ...
            if (searchValue != '') {
                let url = '<?php echo e(url("/")); ?>' + '/admin/distribution/' + searchValue;
        ...
        $(document).on('click', '.modalOTP', function () {
            ...
            $("#loader").fadeOut(1500);
            $.ajax({
                url: '<?php echo e(url("api/sendOtp")); ?>',
                method: 'post',
                data: {
        ...
        $(document).on('click', '.otp-verify-btn', function () {
            ...
            if (otp == '') {
                ...
                $("#loader").fadeOut(2000);
                $.ajax({
                    url: '<?php echo e(url("api/verifyOtp")); ?>',
                    method: 'post',
                    data: {
                        'distribution_id': rowid,
                        'purpose': 'distribution_verification',
        ...
        function lastDistribution() {
            setInterval(function () {
                $.ajax({
                    url: '<?php echo e(url("api/last-distributed/".$union_id)); ?>',
                    method: 'get',
                    dataType: 'json',
                    success: function (response) {
                        console.log(response);
        ...
        function distributionUnion() {
            setInterval(function () {
                $.ajax({
                    url: '<?php echo e(url("api/union_distribution/".$union_id)); ?>',
                    method: 'get',
                    dataType: 'json',
                    success: function (response) {
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/melandah/vgf.melandahbhata.gov.bd/resources/views/backend/user/beneficiary/distribution1.blade.php ENDPATH**/ ?>